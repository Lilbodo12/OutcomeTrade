...
#[derive(Debug)]
pub struct OutcomeTradeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl OutcomeTradeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting OutcomeTrade processing");
    
    let mut processor = OutcomeTradeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = OutcomeTradeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = OutcomeTradeProcessor::new(false);
